"""
Django settings for csvql project.
...
ALLOWED_HOSTS = [
    '*',
    '127.0.0.1',
    'csvql.programmingondemand.com',
    'www.csvql.programmingondemand.com',
]
...
WSGI_APPLICATION = 'csvql.wsgi.application'
